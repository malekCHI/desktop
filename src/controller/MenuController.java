...
public class MenuController implements Initializable {
    ...
    @FXML
    private void shows(MouseEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/view/ajouter_reclamation.fxml"));
            Stage stage = (Stage) showss.getScene().getWindow();
            stage.close();
